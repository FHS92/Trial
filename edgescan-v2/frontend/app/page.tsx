        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 py-20">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div>
              ...
              <p className="mt-4 text-xs text-zinc-600">No credit card required · Free forever · Upgrade anytime</p>
            </div>
        ...
        <div className="max-w-5xl mx-auto px-6 py-8">
          <div className="flex flex-wrap justify-center divide-x divide-white/8">
            {[
              ...
              <div key={stat.label} className="flex flex-col items-center px-10 py-2">
                <span
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {TESTIMONIALS.map((t, i) => (
              <div
                key={i}
                className="group relative rounded-2xl border border-white/8 bg-white/[0.03] p-7 hover:border-emerald-500/20 hover:bg-emerald-500/[0.02] transition-all duration-300"
              >
                <div
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {FEATURES.map((feature) => (
              <div
                key={feature.title}
                className="group rounded-2xl border border-white/8 bg-white/[0.02] p-7 hover:border-emerald-500/20 hover:bg-emerald-500/[0.03] transition-all duration-300 hover:-translate-y-0.5 relative overflow-hidden"
              >
                <div
                  className="absolute top-0 left-0 right-0 h-px opacity-0 group-hover:opacity-100 transition-opacity"
                  style={{ background: 'linear-gradient(90deg, transparent, #10b981 50%, transparent)' }}
